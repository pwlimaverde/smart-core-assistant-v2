import 'package:dependencies_module/dependencies_module.dart' hide ServiceHealth;
  ...
  Widget _buildHealthList(List<ServiceHealth> services) {
    if (services.isEmpty) {
      return const AppCard(
        ...
        child: Center(
          child: Text('Nenhum dado de saúde reportado.'),
        ),
      );
    }
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            subtitle: Text(service.message.isEmpty ? 'Operando normalmente' : service.message),
            trailing: Row(
