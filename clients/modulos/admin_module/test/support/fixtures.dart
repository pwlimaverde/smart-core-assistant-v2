...
import 'package:admin_module/src/features/config/domain/model/service_health.dart';
...
TenantConfig tenantConfigFixture({
...
EvolutionConnectionResult evolutionResultFixture({String status = 'connected'}) =>
...
FeatureFlag featureFlagFixture({String key = 'nova_ui'}) => FeatureFlag(
      ...
      overrides: const [
        FeatureFlagOverride(tenantId: 'tenant-1', enabled: true),
      ],
    );
