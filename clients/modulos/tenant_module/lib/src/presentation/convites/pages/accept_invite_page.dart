import 'package:dependencies_module/dependencies_module.dart' hide AcceptedTenantUser;
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (token.isEmpty)
                    ...
                    AppTextField(label: 'Nome de usuário', hint: 'ex: maria.silva', controller: _usernameController),
                    const SizedBox(height: 16),
                    AppTextField(
                      label: 'E-mail',
                    ...
                    ViewStateBuilder<AcceptInviteController, AcceptedTenantUser>(
  ...
  Widget _buildSubmitButton(String token) {
    return PrimaryButton(
      ...
      onPressed: () {
        ...
        _controller.accept(token: token, username: username, email: email, password: password);
      },
    );
  }
}
