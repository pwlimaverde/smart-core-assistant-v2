...
class _TenantUsersPageState extends State<TenantUsersPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => _controller.fetchUsers());
  }
                ...
                child: SingleChildScrollView(
                  ...
                  child: DataTable(
                    columns: const [
                      ...
                      DataColumn(label: Text('Escopos', style: TextStyle(fontWeight: FontWeight.bold))),
                      DataColumn(label: Text('Fluxos', style: TextStyle(fontWeight: FontWeight.bold))),
  ...
  void _showEditDialog(BuildContext context, TenantUser user) {
    ...
    final flowsController = TextEditingController(text: user.flowPermissions.join(', '));
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Escopos', style: TextStyle(fontWeight: FontWeight.bold)),
                    ..._escoposConhecidos.map((s) => CheckboxListTile(
                          dense: true,
                          title: Text(s),
              ...
              PrimaryButton(
                ...
                onPressed: () async {
                  ...
                  if (dialogContext.mounted) {
                    ...
                    } else if (res is ErrorReturn<Unit>) {
