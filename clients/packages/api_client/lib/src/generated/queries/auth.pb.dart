...
class RegisterRequest extends $pb.GeneratedMessage {
  factory RegisterRequest({
    ...
    if (tenantSlug != null) result.tenantSlug = tenantSlug;
    return result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(5, _omitFieldNames ? '' : 'tenantName')
    ..aOS(6, _omitFieldNames ? '' : 'tenantSlug')
  ...
  @$pb.TagNumber(5)
  $core.String get tenantName => $_getSZ(4);
  @$pb.TagNumber(5)
  set tenantName($core.String value) => $_setString(4, value);
  @$pb.TagNumber(5)
  $core.bool hasTenantName() => $_has(4);
  @$pb.TagNumber(5)
  void clearTenantName() => $_clearField(5);

  @$pb.TagNumber(6)
  $core.String get tenantSlug => $_getSZ(5);
  @$pb.TagNumber(6)
  set tenantSlug($core.String value) => $_setString(5, value);
  @$pb.TagNumber(6)
  $core.bool hasTenantSlug() => $_has(5);
  @$pb.TagNumber(6)
  void clearTenantSlug() => $_clearField(6);
}
