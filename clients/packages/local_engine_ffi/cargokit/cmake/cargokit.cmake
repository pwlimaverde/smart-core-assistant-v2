...
if(WIN32)
    ...
    # -NoProfile: o build nao deve depender do $PROFILE interativo de quem roda
    # (ex.: modulos de terminal quebrados em sessao aninhada nao-interativa).
    execute_process(COMMAND powershell -NoProfile -ExecutionPolicy Bypass -File "${CMAKE_CURRENT_LIST_DIR}/resolve_symlinks.ps1" "${cargokit_cmake_root}" OUTPUT_VARIABLE cargokit_cmake_root OUTPUT_STRIP_TRAILING_WHITESPACE)
endif()
