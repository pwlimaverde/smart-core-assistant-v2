...
# (com segredos) ficam fora do git, em docker/dev/.env e docker/prod/.env. Faça
# uma cópia local antes de rodar este backup, se eles vivem só no servidor.
$EnvFiles = @{
    "App-Local" = "../.env"
    "Env-Dev"   = "../docker/dev/.env"
    "Env-Prod"  = "../docker/prod/.env"
}
