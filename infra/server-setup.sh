...
echo ""
echo "  2b. [N4.1] Após o primeiro boot do Postgres, rodar UMA VEZ por ambiente:"
echo "        infra/provision-db-role.sh (separa role de runtime x role admin,"
echo "        destravando o RLS de verdade — ver comentários no script e em"
echo "        docker/dev/.env.example / docker/prod/.env.example)."
echo ""
